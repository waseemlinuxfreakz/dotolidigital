    ...
    <>
      ...
      <div style={{ overflow: "hidden" }}>
        ...
        <LeftImgSection
          ...
          description={
            "From lifelike 3D walkthroughs to fully immersive property tours — we bring empty plots to life before they’re built."
          }
        ...
        <LeftImgSection
          ...
          description={
            "From lead to loyalty — our CRM setups and automations (Close, HubSpot, Follow Up Boss) keep your pipeline flowing and your team focused."
          }
          images={"k2.webp"}
          btn_text={"Explore work"}
        ...
        <RightImgSection
          ...
          description={
            "Custom-built AI agents and automation flows powered by tools like Make.com, Zapier, and n8n—designed to qualify leads, automate support, and run your business on autopilot."
          }
          images={"k3.webp"}
          btn_text={"Explore work"}
