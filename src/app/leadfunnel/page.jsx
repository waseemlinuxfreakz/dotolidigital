      ...
      <div ref={containerRef}>
        ...
        <section className="container1 section-padding gsap-fade-up">
          ...
          <p className="section-desc">
            ...
            without warning. Your customers come from word of mouth and chance,
            so the quiet months are the ones that keep you up. When the phone
            slows down there is nothing to switch back on, because you are the
            system. That caps how big you can get, and it chains the business to
            you.
          </p>
        ...
        <section className="container1 section-padding gsap-fade-up">
          ...
          <p className="section-desc">
            We know what it feels like to run the whole operation and still
            wonder where the next job comes from. So we build the four parts
            that turn strangers into booked jobs, and we run them for you. Ads
            are one input, not the product.
          </p>
          ...
          <div className="system-grid">
            ...
            <div className="shell">
              <div className="system-card">
                <span className="system-card-step">
                  03 / THE CREATIVE ENGINE
                </span>
          ...
          <div className="system-callout">
            This is not ad management. We build the whole machine, prove it in
            30 days, then <strong>you</strong> decide. You keep everything we
            build.
          </div>
        </section>
        ...
        {/* ───── PROCESS SECTION ───── */}
        <section
          className="container1 section-padding gsap-fade-up"
          id="how-to-work"
        >
            ...
            <div className="shell">
              <div className="process-card">
                ...
                <h3 className="process-card-title">
                  The 30-Day Traction Pilot
                </h3>
                <p className="process-card-desc">
                  One offer, one audience, one campaign. We prove we can bring
                  you customers at a price that makes sense. Flat fee plus your
                  ad spend, which stays on your card and your pixel. Your
                  Decision Day is booked for day 30 before we start.
                </p>
              </div>
            </div>
            ...
            <div className="shell">
              <div className="process-card">
                ...
                <p className="process-card-desc">
                  ...
                  written cost-per-booked-job target. Stop any time, and you
                  keep the system. Most operators never want to.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="timeline-grid">
            ...
            <div className="timeline-item">
              ...
              <h4>WEEK 1 ON</h4>
              <p>
                Leads start coming in. You answer the phone. The Scoreboard
                fills in live.
              </p>
            </div>
            <div className="timeline-item">
        ...
        {/* ───── PROOF SECTION ───── */}
        <section className="container1 section-padding gsap-fade-up" id="proof">
            ...
            <div className="case-study">
              <div className="cs-header">
                <div className="cs-main">
                  ...
                  <p>
                    Jenny ran a custom kitchen remodeling company on word of
                    mouth alone. Beautiful work, loyal crews, and the same
                    question every month: where is the next job coming from.
                  </p>
                  ...
                  <p style={{ fontSize: "13px" }}>
                    A 28.4x return on ad spend over 6.5 months. Booked,
                    contracted kitchen remodels, not impressions.
                  </p>
                </div>
              ...
              <div className="cs-details-grid">
                <div className="cs-details-col">
                  ...
                  <ul>
                    ...
                    <li>
                      Boosted posts that spent money with nothing to show.
                    </li>
                ...
                <div className="cs-details-col">
                  ...
                  <ul>
                    <li>
                      Direct-response video on her real kitchens and crew.
                    </li>
              ...
              <div className="cs-testimonial">
                "I'm sorry I'm being emotional but I wanna thank Jared and
                Khalid for coming into our lives. This is actually working and
                I'm so overwhelmed and happy at the same time."
            ...
            <div className="case-study">
              <div className="cs-header">
                <div className="cs-main">
                  ...
                  <p>
                    Great crews, a cold pipeline. Most demolition companies do
                    not have a lead problem, they have a follow-up problem:
                    calls go unanswered and leads go cold in hours. We rebuilt
                    the whole chain from click to invoice.
                  </p>
                  <div className="cs-huge-numbers">
                    <span>~$6,000</span> in.
                    <br />
                  ...
                  <p style={{ fontSize: "13px" }}>
                    Invoiced demolition work over two months, on the client's
                    own Meta and Google accounts. The follow-up system is what
                    turned cheap clicks into booked jobs.
                  </p>
                </div>
                <div className="cs-sidebar">
                  <div className="cs-sidebar-item">
              ...
              <div className="cs-details-grid">
                <div className="cs-details-col">
                  ...
                  <ul>
                    ...
                    <li>
                      No retargeting, so prospects compared 3 to 5 contractors
                      and forgot them.
                    </li>
                  </ul>
                </div>
                <div className="cs-details-col">
                  ...
                  <ul>
                    ...
                    <li>
                      A CRM pipeline from lead to quote to job to invoice.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="container1 section-padding gsap-fade-up">
          ...
          <p className="section-desc">
            The Pilot only works when both sides show up. Here is who it is
            built for, and who it is not.
          </p>
          ...
          <div className="who-grid">
            <div className="who-card">
              ...
              <ul className="who-list">
                ...
                <li>
                  <FaCheck className="icon-check" /> You answer your phone
                ...
                <li>
                  <FaCheck className="icon-check" /> You are coachable on
                  creative and offer.
                </li>
              </ul>
            </div>
            <div className="who-card sm2">
              ...
              <ul className="who-list">
                ...
                <li>
                  <FaTimes className="icon-cross" /> You will not shoot or
                  approve real creative on your business.
                </li>
                <li>
          ...
          <div className="shell">
            <div className="guarantee-box">
              <div className="g-left">
                ...
                <p>
                  The ad spend stays on your card and your pixel. There is no
                  long contract. On Decision Day we read the Scoreboard together
                  and you decide. Either way, you keep everything we built.
                </p>
              </div>
        ...
        <section className="container1 section-padding final-cta gsap-fade-up">
          ...
          <p className="sm-final-cta-desc">
            ...
            job, on your own ad account. The only question is whether the jobs
